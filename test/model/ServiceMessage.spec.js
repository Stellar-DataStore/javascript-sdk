...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StellarDataStore.ServiceMessage();
  });
  ...
  describe('ServiceMessage', function() {
    it('should create an instance of ServiceMessage', function() {
      // uncomment below and update the code to test ServiceMessage
      //var instance = new StellarDataStore.ServiceMessage();
      //expect(instance).to.be.a(StellarDataStore.ServiceMessage);
    });
