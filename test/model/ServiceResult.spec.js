...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StellarDataStore.ServiceResult();
  });
  ...
  describe('ServiceResult', function() {
    it('should create an instance of ServiceResult', function() {
      // uncomment below and update the code to test ServiceResult
      //var instance = new StellarDataStore.ServiceResult();
      //expect(instance).to.be.a(StellarDataStore.ServiceResult);
    });
