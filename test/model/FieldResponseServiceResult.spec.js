...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StellarDataStore.FieldResponseServiceResult();
  });
  ...
  describe('FieldResponseServiceResult', function() {
    it('should create an instance of FieldResponseServiceResult', function() {
      // uncomment below and update the code to test FieldResponseServiceResult
      //var instance = new StellarDataStore.FieldResponseServiceResult();
      //expect(instance).to.be.a(StellarDataStore.FieldResponseServiceResult);
    });
