...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StellarDataStore.TableResponseIEnumerableServiceResult();
  });
  ...
  describe('TableResponseIEnumerableServiceResult', function() {
    it('should create an instance of TableResponseIEnumerableServiceResult', function() {
      // uncomment below and update the code to test TableResponseIEnumerableServiceResult
      //var instance = new StellarDataStore.TableResponseIEnumerableServiceResult();
      //expect(instance).to.be.a(StellarDataStore.TableResponseIEnumerableServiceResult);
    });
