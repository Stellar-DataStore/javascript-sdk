...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StellarDataStore.IServiceResult();
  });
  ...
  describe('IServiceResult', function() {
    it('should create an instance of IServiceResult', function() {
      // uncomment below and update the code to test IServiceResult
      //var instance = new StellarDataStore.IServiceResult();
      //expect(instance).to.be.a(StellarDataStore.IServiceResult);
    });
