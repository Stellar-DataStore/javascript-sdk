...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new StellarDataStore.AbstractObjectServiceResult();
  });
  ...
  describe('AbstractObjectServiceResult', function() {
    it('should create an instance of AbstractObjectServiceResult', function() {
      // uncomment below and update the code to test AbstractObjectServiceResult
      //var instance = new StellarDataStore.AbstractObjectServiceResult();
      //expect(instance).to.be.a(StellarDataStore.AbstractObjectServiceResult);
    });
